...
const applicationServerPublicKey =
	'BCeC20t45COCWZ_w4gSv3K8_y2ip3eaz9Hg3AqLEBpc8HhmtAZbtCY02Qn1HGcVfjU06auN8z_fKkkAUaYe5Cig';
	...
	if ( event.request.url.includes( '/documentation/examples/components/amp-web-push/send-push' ) ) {
		event.respondWith(
			( async () => {
				...
				return fetch(
					self.location.origin + '/documentation/examples/components/amp-web-push/send-push',
					options
				);
			} )()
		);
