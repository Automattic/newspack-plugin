		...
		$this->assertEquals(
			[
				...
				'metadata' => [
					...
					'payment_page_utmsource'   => 'test_source',
					'payment_page_utmmedium'   => '',
					'payment_page_utmcampaign' => 'test_campaign',
					'payment_page_utmterm'     => 'test_term',
					'payment_page_utmcontent'  => 'test_content',
					'sub_start_date'           => '',
					'sub_end_date'             => '',
					'billing_cycle'            => '',
					'recurring_payment'        => '',
