		...
		<div class="newspack-ui__modal newspack-ui__modal--small">
				...
				<section class="newspack-ui__modal__content">
					<form name="newspack-group-subscription-invite-member" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
						...
						<button type="button" class="newspack-ui__button newspack-ui__button--primary newspack-ui__button--wide newspack-ui__modal__close"><?php esc_html_e( 'Close', 'newspack-plugin' ); ?></button>
						<?php else : ?>
