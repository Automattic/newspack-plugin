...
class WooCommerce {
	...
	public static function init() {
		...
		add_filter( 'woocommerce_order_again_cart_item_data', [ __CLASS__, 'order_again_cart_item_data' ] );
	}
	 ...
	 * @return array
	 */
	public static function order_again_cart_item_data( $cart_item_data ) {
