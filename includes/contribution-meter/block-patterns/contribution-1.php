<?php
/**
 * Contribution Meter Pattern 1: Two-column with gradient background.
 *
 * @package Newspack
 */
...
<div class="wp-block-group alignwide newspack-pattern contribution__style-1 has-border-color" style="border-color:#DDDDDD;border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">
	...
	<div class="wp-block-columns alignwide contribution" style="padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
		...
		<!-- wp:column {"verticalAlignment":"center","width":"50%","style":{"spacing":{"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60","right":"var:preset|spacing|60"}},"border":{"radius":"4px"}}} -->
		<div class="wp-block-column is-vertically-aligned-center" style="border-radius:4px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60);flex-basis:50%">
