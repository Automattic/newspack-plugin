...
$post_content =
	...
	<!-- wp:paragraph -->
	<p>' . __( 'Someone attempted to sign into your account on *SITE_TITLE*. Please use the following link to sign in:', 'newspack-plugin' ) . '</p>
	<!-- /wp:paragraph -->
