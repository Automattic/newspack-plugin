...
$post_content =
	...
	<div class="wp-block-buttons has-custom-font-size has-medium-font-size" style="font-style:normal;font-weight:400"><!-- wp:button {"textAlign":"center","textColor":"' . esc_attr( $primary_text_color ) . '","style":{"color":{"background":"' . esc_attr( $primary_color ) . '"},"border":{"radius":"4px"},"elements":{"link":{"color":{"text":"' . esc_attr( $primary_text_color ) . '"}}}}} -->
	<div class="wp-block-button"><a class="wp-block-button__link has-' . esc_attr( $primary_text_color ) . '-color has-text-color has-background has-link-color has-text-align-center wp-element-button" href="*MAGIC_LINK_URL*" style="border-radius:4px;background-color:' . esc_attr( $primary_color ) . '">' . sprintf( /* Translators: s is the site's title. */ __( 'Continue to %s', 'newspack' ), '*SITE_TITLE*' ) . '</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons -->
	<!-- wp:paragraph -->
	<p>' . __( 'Or copy and paste the link in your browser:', 'newspack' ) . ' <br><a href="*MAGIC_LINK_URL*" data-type="URL" data-id="*MAGIC_LINK_URL*">*MAGIC_LINK_URL*</a></p>
	<!-- /wp:paragraph -->
	<!-- wp:paragraph -->
	...
	<ul class="wp-block-social-links has-icon-color has-icon-background-color is-style-filled-white">' . $social_links . '</ul>
	<!-- /wp:social-links -->
...
$email_html =
	...
	<style media="screen and (min-width:480px)">.moz-text-html .mj-column-per-100 { width:100% !important; max-width: 100%; }</style><style type="text/css">@media only screen and (max-width:479px) {
	...
	.has-secondary-variation-color { color: ' . esc_attr( $secondary_color ) . '; }
