...
return array(
  ...
  <p class="has-text-align-center has-x-large-font-size"><code>*MAGIC_LINK_OTP*</code></p>
  <!-- /wp:paragraph -->

  <!-- wp:paragraph -->
  <p>' . __( 'You can also log into your account by clicking the following button:', 'newspack' ) . '</p>
  <!-- /wp:paragraph -->
  ...
  <!-- /wp:paragraph -->',
	'email_html'   => '<!doctype html><html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head><title>Authentication link</title><!--[if !mso]><!--><meta http-equiv="X-UA-Compatible" content="IE=edge"><!--<![endif]--><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style type="text/css">#outlook a { padding:0; }
