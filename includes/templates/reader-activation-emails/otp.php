...
$post_content =
	...
	<div class="wp-block-button"><a class="wp-block-button__link has-' . esc_attr( $primary_text_color ) . '-color has-text-color has-background has-link-color has-text-align-center wp-element-button" href="*MAGIC_LINK_URL*" style="border-radius:4px;background-color:' . esc_attr( $primary_color ) . '">' . sprintf( /* Translators: s: site title. */ __( 'Continue to %s', 'newspack-plugin' ), '*SITE_TITLE*' ) . '</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons -->
	<!-- wp:paragraph -->
