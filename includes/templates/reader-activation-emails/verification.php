...
return array(
  ...
  <!-- wp:heading -->
  <h2>' . __( 'Hi there!', 'newspack' ) . '</h2>
  <!-- /wp:heading -->

  <!-- wp:paragraph -->
  <p>' . __( 'To manage your account, please verify your email address by clicking the link below:', 'newspack' ) . '</p>
  <!-- /wp:paragraph -->

  <!-- wp:buttons -->
  <div class="wp-block-buttons"><!-- wp:button {"style":{"color":{"background":"#dd3333"}}} -->
  <div class="wp-block-button"><a class="wp-block-button__link has-background" href="*VERIFICATION_URL*" style="background-color:#dd3333">' . __( 'Verify my email', 'newspack' ) . '</a></div>
  <!-- /wp:button --></div>
  <!-- /wp:buttons -->

  <!-- wp:paragraph -->
  <p>' . __( 'Or copy and paste the link in your browser:', 'newspack' ) . ' <a href="*VERIFICATION_URL*" data-type="URL" data-id="*VERIFICATION_URL*">*VERIFICATION_URL*</a></p>
  <!-- /wp:paragraph -->

  <!-- wp:paragraph -->
  <p>' . __( 'Once verified, you\'ll be able to edit your profile, set a password for easier access, and manage your newsletter subscriptions and billing information.', 'newspack' ) . '</p>
  <!-- /wp:paragraph -->',
