...
return array(
  ...
  <!-- wp:paragraph -->
  <p>Or copy and paste the link in your browser: <a href="*VERIFICATION_URL*" data-type="URL" data-id="*VERIFICATION_URL*">*VERIFICATION_URL*</a></p>
  <!-- /wp:paragraph -->
