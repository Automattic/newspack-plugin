...
$post_content =
	...
	<h2 class="wp-block-heading" style="font-style:normal;font-weight:400">' . __( 'Delete your account', 'newspack-plugin' ) . '</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-button"><a class="wp-block-button__link has-secondary-color has-primary-background-color has-text-color has-background has-link-color has-text-align-center wp-element-button" href="*DELETION_LINK*" style="border-radius:4px">' . __( 'Delete my account', 'newspack-plugin' ) . '</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons -->
	<!-- wp:paragraph -->
	...
	<p class="has-small-font-size">' . sprintf( /* Translators: 1: site title 2: site base address. */ __( '%1$s - %2$s', 'newspack-plugin' ), '<strong>*SITE_TITLE*</strong>', '*SITE_ADDRESS*' ) . '<br>' . sprintf( /* Translators: 1: link to site url. */ __( 'You received this email because you requested to delete your %s account.', 'newspack-plugin' ), '<a href="*SITE_URL*">*SITE_URL*</a>' ) . '</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:group -->';
