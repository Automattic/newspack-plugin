...
$post_content =
	...
	<p style="font-style:normal;font-weight:400">' .
		sprintf(
			...
			__( 'Click the magic link below to finish signing in. You also have the option to %1$screate a password%2$s for your account.', 'newspack-plugin' ),
