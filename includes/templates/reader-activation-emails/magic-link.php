...
$post_content =
	...
	<p style="font-style:normal;font-weight:400">' . sprintf( /* Translators: 1: Opening HTML anchor tag. 2: Closing HTML anchor tag. */ __( 'Click the magic link below to continue where you left off. You also have the option to %1$screate a password%2$s for your account.', 'newspack-plugin' ), '<a href="*SET_PASSWORD_LINK*">', '</a>' ) . '</p>
	<!-- /wp:paragraph -->
