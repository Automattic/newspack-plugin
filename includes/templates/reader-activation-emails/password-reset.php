...
$post_content =
	...
	<h2 class="wp-block-heading" style="font-size:46px;font-style:normal;font-weight:500">' . __( 'Reset password', 'newspack-plugin' ) . '</h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph {"style":{"typography":{"fontStyle":"normal","fontWeight":"400"}}} -->
	<p style="font-style:normal;font-weight:400">' . __( 'You have just requested a password reset for your account associated with this email address.', 'newspack-plugin' ) . '</p>
	<!-- /wp:paragraph -->
...
$email_html = '
	...
	<html lang="und" dir="auto" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
		<head>
			<title>' . __( 'Reset password', 'newspack-plugin' ) . '</title>
			<!--[if !mso]><!-->
...
return array(
	'post_title'   => __( 'Reset password', 'newspack-plugin' ),
