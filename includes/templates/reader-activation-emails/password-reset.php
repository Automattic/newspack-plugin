...
$post_content =
	...
	<div class="wp-block-group has-primary-background-color has-' . esc_attr( $primary_text_color ) . '-color has-text-color has-background has-link-color" style="background-color:' . esc_attr( $primary_color ) . ';padding-top:56px;padding-right:56px;padding-bottom:56px;padding-left:56px">
		...
		<p class="has-small-font-size">' . sprintf( /* Translators: 1: site title 2: site base address. */ __( '%1$s - %2$s', 'newspack' ), '<strong>*SITE_TITLE*</strong>', '*SITE_ADDRESS*' ) . '<br>' . sprintf( /* Translators: 1: link to site url. */ __( 'You received this email because you are registered on %s.', 'newspack' ), '<a href="*SITE_URL*">*SITE_URL*</a>' ) . '</p>
		<!-- /wp:paragraph -->
	</div>
	<!-- /wp:group -->';
