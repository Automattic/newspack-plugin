...
return array(
	'post_title'   => __( 'Reset your password', 'newspack' ),
	'post_content' => '<!-- wp:site-logo {"align":"center"} /-->

  <!-- wp:heading -->
  <h2>' . __( 'Reset your password', 'newspack' ) . '</h2>
  <!-- /wp:heading -->

  <!-- wp:paragraph -->
  <p>' . __( 'Reset your password by clicking this button:', 'newspack' ) . '</p>
  <!-- /wp:paragraph -->

  <!-- wp:buttons -->
  <div class="wp-block-buttons"><!-- wp:button {"style":{"color":{"background":"#dd3333"}}} -->
  <div class="wp-block-button"><a class="wp-block-button__link has-background" href="*PASSWORD_RESET_LINK*" style="background-color:#dd3333">' . __( 'Reset password', 'newspack' ) . '</a></div>
  <!-- /wp:button --></div>
  <!-- /wp:buttons -->
