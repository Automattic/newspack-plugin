...
$post_content =
	...
	<h2 class="wp-block-heading" style="font-style:normal;font-weight:400">' . __( 'Reset password', 'newspack' ) . '</h2>
	<!-- /wp:heading -->
	<!-- wp:paragraph -->
	<p>' . __( 'You have just requested a password reset for your account associated with this email address.', 'newspack' ) . '</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-button"><a class="wp-block-button__link has-' . esc_attr( $primary_text_color ) . '-color has-text-color has-background has-link-color has-text-align-center wp-element-button" href="*PASSWORD_RESET_LINK*" style="border-radius:4px;background-color:' . esc_attr( $primary_color ) . '">' . __( 'Reset password', 'newspack' ) . '</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons -->
	<!-- wp:paragraph -->
	<p>' . sprintf( /* Translators: 1: opening HTML anchor tag 2: closing HTML anchor tag */ __( 'If you continue to have issues signing in, please %1$scontact us%2$s.', 'newspack' ), '<a href="https://help.newspack.com">', '</a>' ) . '</p>
	<!-- /wp:paragraph --></div>
	<!-- /wp:group -->' .
	// Footer.
