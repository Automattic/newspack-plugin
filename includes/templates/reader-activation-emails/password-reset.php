...
$post_content =
	...
	<h2 class="wp-block-heading" style="font-style:normal;font-weight:400">' . __( 'Reset password', 'newspack-plugin' ) . '</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-button"><a class="wp-block-button__link has-secondary-color has-primary-background-color has-text-color has-background has-link-color has-text-align-center wp-element-button" href="*PASSWORD_RESET_LINK*" style="border-radius:4px">' . __( 'Reset password', 'newspack-plugin' ) . '</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons -->
	<!-- wp:paragraph -->
