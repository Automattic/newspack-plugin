...
$post_content =
	...
	<h2 class="wp-block-heading" style="font-style:normal;font-weight:400">' . __( 'Thank you!', 'newspack-plugin' ) . '</h2>
	<!-- /wp:heading -->
