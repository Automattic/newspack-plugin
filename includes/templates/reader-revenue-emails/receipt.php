...
$post_content =
	...
	<h2 class="wp-block-heading" style="font-size:46px;font-style:normal;font-weight:500">' . __( 'Thank you!', 'newspack-plugin' ) . '</h2>
	<!-- /wp:heading -->

	<!-- wp:paragraph -->
	<p>' . sprintf( /* Translators: s: the site title. */ __( 'Thank you for supporting %s. Here is a receipt for your recent transaction:', 'newspack-plugin' ), '*SITE_TITLE*' ) . '</p>
	<!-- /wp:paragraph -->
...
$email_html = '
	...
	<html lang="und" dir="auto" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
		<head>
			<title>' . __( 'Thank you!', 'newspack-plugin' ) . '</title>
			<!--[if !mso]><!-->
...
return array(
	'post_title'   => __( 'Thank you!', 'newspack-plugin' ),
