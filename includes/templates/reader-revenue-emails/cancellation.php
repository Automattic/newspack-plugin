...
$post_content =
	...
	<h2 class="wp-block-heading" style="font-style:normal;font-weight:400">*CANCELLATION_TITLE*</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-button"><a class="wp-block-button__link has-secondary-color has-primary-background-color has-text-color has-background has-link-color has-text-align-center wp-element-button" href="*SUBSCRIPTION_URL*" style="border-radius:4px">*BUTTON_TEXT*</a></div>
	<!-- /wp:button --></div>
	<!-- /wp:buttons -->
