...
<!-- wp:paragraph -->
<p>' . __( 'Your recurring donation has been cancelled', 'newspack' ) . '</p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph -->
<p>' . sprintf( /* Translators: s: link to the subscription management page in MY Account. */ __( 'You can manage your subscription at %s.', 'newspack' ), '*SUBSCRIPTION_URL*' ) . '</p>
<!-- /wp:paragraph -->',
