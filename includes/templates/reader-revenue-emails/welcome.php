...
$post_content =
	...
	<h2 class="wp-block-heading" style="font-style:normal;font-weight:400">' . __( 'Thank you and welcome!', 'newspack-plugin' ) . '</h2>
	<!-- /wp:heading -->
	...
	<p class="has-small-font-size">' . sprintf( /* Translators: 1: site title 2: site base address. */ __( '%1$s - %2$s', 'newspack-plugin' ), '<strong>*SITE_TITLE*</strong>', '*SITE_ADDRESS*' ) . '<br>' . sprintf( /* Translators: 1: link to site url. */ __( 'You received this email because you supported %s', 'newspack-plugin' ), '<a href="*SITE_URL*">*SITE_URL*</a>' ) . '</p>
	<!-- /wp:paragraph -->
