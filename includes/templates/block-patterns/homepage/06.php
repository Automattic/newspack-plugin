...
<!-- wp:group {"className":"newspack-pattern homepage-posts__style-28"} -->
<div class="wp-block-group newspack-pattern homepage-posts__style-28"><div class="wp-block-group__inner-container"><!-- wp:columns -->
<div class="wp-block-columns"><!-- wp:column {"width":"20%"} -->
<div class="wp-block-column" style="flex-basis:20%"><!-- wp:newspack-blocks/homepage-articles {"showExcerpt":false,"showAuthor":false,"postsToShow":1,"authors":[],"categories":[],"tags":[],"tagExclusions":[],"specificPosts":[],"typeScale":2} /--></div>
<!-- /wp:column -->
