...
return array(
	'content' => '<!-- wp:group {"className":"newspack-pattern homepage-posts__style-1"} -->
<div class="wp-block-group newspack-pattern homepage-posts__style-1"><div class="wp-block-group__inner-container"><!-- wp:columns -->
...
<!-- wp:group {"className":"newspack-pattern homepage-posts__style-7"} -->
