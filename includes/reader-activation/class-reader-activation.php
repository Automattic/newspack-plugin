		...
		?>
			<div class="newspack-ui newspack-newsletters-signup">
				<form method="post" target="_top">
					...
					<div class="newspack-ui__vstack overflow-hidden position-relative newsletter-list-container" data-gap="2" data-list-default-size="<?php echo esc_attr( $default_list_size ); ?>">
					<?php
