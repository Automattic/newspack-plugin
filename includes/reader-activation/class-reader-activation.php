...
final class Reader_Activation {
	...
	public static function cli_setup_ras() {
		if ( self::is_ras_campaign_configured() ) {
			\WP_CLI::error( __( 'RAS is alreaady configured for this site.', 'newspack-plugin' ) );
		}
	...
	public static function cli_verify_reader( $args, $assoc_args ) {
		...
		if ( method_exists( '\Newspack_Newsletters_Subscription', 'set_email_verified' ) ) {
			\Newspack_Newsletters_Subscription::set_email_verified( $user->ID );
		}
