...
class Reader_Activation_Emails {
	...
	public static function add_email_configs( $configs ) {
		...
		$configs[ self::EMAIL_TYPES['MAGIC_LINK'] ]     = [
			...
			'description'            => __( 'Email sent to users with a login link generated by Admin user or when one-time password is disabled.', 'newspack' ),
		...
		$configs[ self::EMAIL_TYPES['OTP_AUTH'] ]       = [
			...
			'description'            => __( 'Email sent to users with a one-time password and login link.', 'newspack' ),
