...
final class Newspack {
	...
	private function includes() {
		...
		include_once NEWSPACK_ABSPATH . 'includes/data-events/class-ras-data.php';
		...
		include_once NEWSPACK_ABSPATH . 'includes/plugins/wc-memberships/class-wc-memberships.php';
