<div class="newspack-card">
	...
	<div class="newspack-wizard__manage-subscriptions-product-actions">
		<a class="edit-subscription" href="<?php echo self_admin_url( 'admin.php?page=newspack-subscriptions-wizard&screen=edit_subscription&subscription=' . absint( $product->get_id() ) ); ?>"><?php echo esc_html__( 'Edit', 'newspack' ); ?></a>
		<a class="delete-subscription" data-subscription="<?php echo esc_attr( $product->get_name() ); ?>" href="<?php echo wp_nonce_url( 'admin.php?page=newspack-subscriptions-wizard&screen=manage_subscriptions&action=delete&subscription=' . absint( $product->get_id() ), 'newspack-delete-subscription_' . $product->get_id(), 'delete_subscription_nonce' ); ?>"><?php echo esc_html__( 'Delete', 'newspack' ); ?></a>
	</div>
</div>
