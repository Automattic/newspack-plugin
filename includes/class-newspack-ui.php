		...
		<div class="newspack-ui">
			...
			<button class="newspack-ui__button newspack-ui__button--secondary">
				<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path fill-rule="evenodd" clip-rule="evenodd" d="M21.6 12.227C21.6 11.518 21.536 10.837 21.418 10.182H12V14.05H17.382C17.2706 14.6619 17.0363 15.2448 16.6932 15.7635C16.3501 16.2822 15.9054 16.726 15.386 17.068V19.578H18.618C20.509 17.836 21.6 15.272 21.6 12.227Z" fill="#4285F4"/>
					<path fill-rule="evenodd" clip-rule="evenodd" d="M12 22C14.7 22 16.964 21.105 18.618 19.577L15.386 17.068C14.491 17.668 13.346 18.023 12 18.023C9.39496 18.023 7.18996 16.263 6.40496 13.9H3.06396V16.49C3.89597 18.1468 5.17234 19.5395 6.7504 20.5126C8.32846 21.4856 10.146 22.0006 12 22Z" fill="#34A853"/>
					<path fill-rule="evenodd" clip-rule="evenodd" d="M6.405 13.9C6.205 13.3 6.091 12.66 6.091 12C6.091 11.34 6.205 10.7 6.405 10.1V7.51001H3.064C2.36401 8.90321 1.99964 10.4408 2 12C2 13.614 2.386 15.14 3.064 16.49L6.404 13.9H6.405Z" fill="#FBBC05"/>
					<path fill-rule="evenodd" clip-rule="evenodd" d="M12 5.977C13.468 5.977 14.786 6.482 15.823 7.473L18.691 4.605C16.959 2.99 14.695 2 12 2C8.08996 2 4.70996 4.24 3.06396 7.51L6.40396 10.1C7.19196 7.736 9.39596 5.977 12 5.977Z" fill="#EA4335"/>
				</svg>
				Sign in with Google
			</button>
