...
<div class="wp-block-group alignwide has-border-color has-base-3-border-color" style="border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-group alignwide">
		<!-- wp:columns {"metadata":{"name":"<?php esc_html_e( 'Tiers', 'newspack-plugin' ); ?>"},"style":{"spacing":{"blockGap":{"top":"0.75rem","left":"0.75rem"}}}} -->
		<div class="wp-block-columns">
			...
			<div class="wp-block-column is-style-rounded has-border-color has-base-3-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
				...
				<!-- wp:group {"metadata":{"name":"<?php esc_html_e( 'Content', 'newspack-plugin' ); ?>"},"style":{"dimensions":{"minHeight":"100%"},"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","orientation":"vertical","verticalAlignment":"space-between","justifyContent":"stretch"}} -->
				<div class="wp-block-group" style="min-height:100%">
					<!-- wp:group {"metadata":{"name":"<?php esc_html_e( 'Details', 'newspack-plugin' ); ?>"},"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
					...
					<!-- wp:newspack-blocks/checkout-button {"text":"<?php esc_html_e( 'Become a Member', 'newspack-plugin' ); ?>","width":100,"className":"is-style-outline","style":{"border":{"radius":"3px"}}} /-->
				</div>
				<!-- /wp:group -->
			...
			<div class="wp-block-column is-style-rounded has-border-color has-contrast-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40);box-shadow:var(--wp--preset--shadow--inset-1)">
				...
				<div class="wp-block-group" style="min-height:100%">
					...
					<!-- wp:newspack-blocks/checkout-button {"text":"<?php esc_html_e( 'Become a Patron', 'newspack-plugin' ); ?>","width":100,"style":{"border":{"radius":"3px"}}} /-->
				</div>
				<!-- /wp:group -->
			...
			<div class="wp-block-column is-style-rounded has-border-color has-base-3-border-color" style="border-width:1px;padding-top:var(--wp--preset--spacing--40);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);padding-left:var(--wp--preset--spacing--40)">
				...
				<div class="wp-block-group" style="min-height:100%">
					...
					<!-- wp:newspack-blocks/checkout-button {"text":"<?php esc_html_e( 'Become a VIP', 'newspack-plugin' ); ?>","width":100,"className":"is-style-outline","style":{"border":{"radius":"3px"}}} /-->
				</div>
				<!-- /wp:group -->
