...
export default withWizardScreen( () => {
	const { is_skipped_campaign_setup, reader_activation_url } = newspackAudienceConfiguration;
	...
	async function onSkipCampaignSetup() {
		...
		try {
			...
			newspackAudienceConfiguration.is_skipped_campaign_setup = request.skipped ? '1' : '';
