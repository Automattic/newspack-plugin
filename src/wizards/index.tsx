...
const components: Record< string, any > = {
	...
	'newspack-audience': {
		...
		component: lazy(
			() => import( /* webpackChunkName: "audience-wizards" */ './audience/views/setup' )
		),
	},
	'newspack-audience-campaigns': {
		label: __( 'Audience Campaigns', 'newspack-plugin' ),
		component: lazy(
			() => import( /* webpackChunkName: "audience-wizards" */ './audience/views/campaigns' )
		),
	},
	'newspack-audience-donations': {
		label: __( 'Audience Donations', 'newspack-plugin' ),
		component: lazy(
			() => import( /* webpackChunkName: "audience-wizards" */ './audience/views/donations' )
		),
	},
	'newspack-audience-subscriptions': {
		label: __( 'Audience Subscriptions', 'newspack-plugin' ),
		component: lazy(
			() => import( /* webpackChunkName: "audience-wizards" */ './audience/views/subscriptions' )
		),
	},
} as const;
