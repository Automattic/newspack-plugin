...
| `action`                      | `string` | `seen` when a content gate becomes visible in the viewport, `form_submission` for form interactions, or `dimsissed` when a modal overlay is dismissed.                              |
